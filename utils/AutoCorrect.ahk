...
; ::usb::USB ; Universal Serial Bus / Commented out because annoying
::bios::BIOS ; Basic Input Output System
; ::cd::CD ; Compact Disc / commented b/c conflict w/ 'cd' 'change directory' (+ nobody use CD anymore)
::dhcp::DHCP ; Dynamic Host Configuration Protocol
; ::dns::DNS ; Domain Name System / Commented out because annoying
; ::hd::HD ; High Definition / not essential
::ip::IP ; Internet Protocol
; ::nic::NIC ; Network Interface Card / conflict with login
...
; TODO add more from https://en.wikipedia.org/wiki/List_of_emoticons
